...
sed $SEDOPTION 's,(\.\.,(https://github.com/ERC725Alliance/erc725.js/main/develop/docs/technical-reference,g' ../docs/tools/erc725js/technical-reference/ERC725.md
sed $SEDOPTION 1d ../docs/tools/erc725js/technical-reference/ERC725.md
...
## Class: LSPFactory
' >> ../docs/tools/lsp-factoryjs/technical-reference/methods.md
sed $SEDOPTION 's,(\.\.,(https://github.com/lukso-network/tools-lsp-factory/tree/main/docs/technical-reference,g' tools-lsp-factory/docs/technical-reference/classes/LSPFactory.md
sed $SEDOPTION /\#\#/s/^/\#/ tools-lsp-factory/docs/technical-reference/classes/LSPFactory.md
sed $SEDOPTION '/#\#\#\# Constructors/d' tools-lsp-factory/docs/technical-reference/classes/LSPFactory.md
...
' >> ../docs/tools/lsp-factoryjs/technical-reference/methods.md
sed $SEDOPTION 's,(\.\.,(https://github.com/lukso-network/tools-lsp-factory/tree/main/docs/technical-reference,g' tools-lsp-factory/docs/technical-reference/classes/LSP3UniversalProfile.md
sed $SEDOPTION /\#\#/s/^/\#/ tools-lsp-factory/docs/technical-reference/classes/LSP3UniversalProfile.md
sed $SEDOPTION '/#\#\#\# Constructors/d' tools-lsp-factory/docs/technical-reference/classes/LSP3UniversalProfile.md
...
## Class: DigitalAsset
' >> ../docs/tools/lsp-factoryjs/technical-reference/methods.md
sed $SEDOPTION 's,(\.\.,(https://github.com/lukso-network/tools-lsp-factory/tree/main/docs/technical-reference,g' tools-lsp-factory/docs/technical-reference/classes/DigitalAsset.md
sed $SEDOPTION /\#\#/s/^/\#/ tools-lsp-factory/docs/technical-reference/classes/DigitalAsset.md
sed $SEDOPTION '/#\#\#\# Constructors/d' tools-lsp-factory/docs/technical-reference/classes/DigitalAsset.md
...
sed $SEDOPTION 's,\\>, \\>,g' ../docs/tools/lsp-factoryjs/technical-reference/methods.md
