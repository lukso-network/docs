...
:::tip ERC725 Inspect
[ERC725 Inspect Tool](https://erc725-inspect.lukso.tech/?network=lukso+mainnet) allows you get all controllers of a Universal Profile under the `AddressPermissions[]` section.
