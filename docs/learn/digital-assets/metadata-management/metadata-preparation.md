...
You can follow our [Deploy Token With Metadata](../../universal-profile/interactions/deploy-token-with-metadata.md) and [Set NFT Metadata](./set-nft-metadata.md) Guides to set or update contract metadata.
