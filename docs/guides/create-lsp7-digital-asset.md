...
In this guide, we will learn how to create our own token (known as [LSP7 Digital Asset](../standards/nft-2.0/lsp7-digital-asset.md)) and transfer it between Universal Profiles (UP).
