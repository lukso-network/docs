...
It is important not to forget the previous step. Otherwise, it might conflict with the UP Browser Extension, and this might prevent you from finalizing the setup process.
