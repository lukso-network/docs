...
### :inbox_tray: **[Download link (v1.0.0-develop.395-MV2)](https://storage.googleapis.com/up-browser-extension/universalprofile-extension-mv2-v1.0.0-develop.395.zip) (All other browsers)**

### :inbox_tray: **[Download link (v1.0.0-develop.395-MV3)](https://storage.googleapis.com/up-browser-extension/universalprofile-extension-mv3-v1.0.0-develop.395.zip) (Chrome)**
