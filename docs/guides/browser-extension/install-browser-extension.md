...
### :inbox_tray: **[Download link (v1.2.1.1-MV2)](https://storage.googleapis.com/up-browser-extension/universalprofile-extension-v1.2.1.1-mv2.zip) (All other browsers)**

### :inbox_tray: **[Download link (v1.2.1.1-MV3)](https://storage.googleapis.com/up-browser-extension/universalprofile-extension-v1.2.1.1-mv3.zip) (Chrome)**
