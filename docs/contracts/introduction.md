...
To set up your developer environment, you can check the 👉 [getting started section for Smart Contract developers](../tutorials/smart-contract-developers/getting-started.md).
