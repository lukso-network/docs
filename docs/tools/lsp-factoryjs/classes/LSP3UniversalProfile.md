...
- upload to IPFS and set the [LSP3 Universal Profile](../../../standards/universal-profile/lsp3-universal-profile-metadata.md) metadata.
...
Uploads the [LSP3Profile](../../../standards/universal-profile/lsp3-universal-profile-metadata.md) data to the desired endpoint. This can be an `https` URL either pointing to
...
Processed [LSP3](../../../standards/universal-profile/lsp3-universal-profile-metadata.md) data and upload URL.
