...
| Name | Type | Description |
| :------ | :------ | :------ |
| `schema` | [`ERC725JSONSchema`](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725JSONSchema.md)[] | More information available here: [LSP-2-ERC725YJSONSchema](https://github.com/lukso-network/LIPs/blob/master/LSPs/LSP-2-ERC725YJSONSchema.md) |
| `address?` | `any` | Address of the ERC725 contract you want to interact with |
| `provider?` | `any` |  |
| `config?` | [`ERC725Config`](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725Config.md) | Configuration object. |
...
| :------ | :------ |
| `address?` | `string` |
| `config` | [`ERC725Config`](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725Config.md) |
| `provider?` | `any` |
| `schema` | [`ERC725JSONSchema`](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725JSONSchema.md)[] |
...
To be able to store your data on the blockchain, you need to encode it according to your [ERC725JSONSchema](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725JSONSchema.md).
...
When omitting the `keyOrKeys` parameter, it will get all the keys (as per [ERC725JSONSchema](https://github.com/ERC725Alliance/erc725.js/tree/main/docs/technical-reference/interfaces/ERC725JSONSchema.md) definition).
