...
:::tip
It is more convenient to use [`fetchData`](01-ERC725.md#fetchdata).
...
Since [`getData`](01-ERC725.md#getdata) exclusively returns data that is stored on the blockchain, `fetchData` comes in handy.
