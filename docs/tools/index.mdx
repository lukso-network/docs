...
Remix IDE is a browser-based development environment that allows you to write, test, and deploy smart contracts directly from your web browser. The guide shows you how to use Remix IDE with LUKSO's LSP smart contracts.
...
<ReferenceCard name="🔍 Blockscout" links={[ 
  {label: 'Mainnet', to: 'https://explorer.lukso.network' },
  {label: 'Testnet', to: 'https://explorer.execution.testnet.lukso.network' },
]}>
