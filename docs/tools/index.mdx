...
<ReferenceCard name="🔍 Inspector Tool" links={[ 
  {label: 'View inspector', to: 'https://erc725-inspect.lukso.tech/?network=lukso+mainnet' },
]}>
...
<ReferenceCard name="🔑 Authorize Controller" links={[
  {label: 'Open Tool', to: 'https://authorize.universalprofile.cloud/' },
  {label: 'Documentation', to: '/tools/management-tools/authorize' },
]}>
...
<ReferenceCard name="DIA" links={[ 
  {label: 'Data feeds', to: 'https://www.diadata.org/blog/post/lukso-partners-with-dia-oracles-mainnet/' },
]}>

<a
  href="https://www.diadata.org/blog/post/lukso-partners-with-dia-oracles-mainnet/"
  target="_blank"
  rel="noopener noreferrer"
  style={{
    display: 'flex',
...
<ReferenceCard name="Gateway VRF" links={[ 
  {label: 'Website', to: 'https://gateway.fm/' },
]}>
...
Verifiable Random Function (VRF) coming to LUKSO, and it will be powered by Gateway.
