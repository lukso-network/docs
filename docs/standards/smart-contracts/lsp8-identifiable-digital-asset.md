...
Sets the **initial owner** of the token, registers the [**LSP8IdentifiableDigitalAsset** `InterfaceId`](./interface-ids.md), and sets the following data keys on the [**ERC725Y Data Key-Value Store**](./lsp0-erc725-account#setdata):
