...
The implementation of the **[LSP0-ERC725Account](./02-lsp0-erc725account.md)** standard does not contain any metadata describing the account.
...
See the [LSP5 - Received Assets](./05-lsp5-received-assets.md) standard page for more information.
...
If the Universal Profile is used with the **[LSP6-KeyManager](./06-lsp6-key-manager.md)** and **[LSP1-UniversalReceiverDelegate](./03-lsp1-universal-receiver-delegate.md)**, the received assets will be automatically registered in the storage. To know how many different assets you have, you can query this key.
