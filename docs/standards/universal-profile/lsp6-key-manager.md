...
See also our [step by step Javascript guide](../../learn/expert-guides//execute-relay-transactions.md) to sign and execute relay transactions via the Key Manager.
